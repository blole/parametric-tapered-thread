...
module collet() difference() {
  //cylinder (diameter=outer_d1, length=length, pitch=4, angle=angle, leadin=2, leadfac=1.2, taper=(outer_d1-outer_d0)/length);
  cylinder(r1=outer_d1/2, r2=outer_d2/2, h=length);
